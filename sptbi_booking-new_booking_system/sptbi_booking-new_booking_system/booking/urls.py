...
from . import views
from .restricted_booking_view import restricted_booking_view, approve_booking, reject_booking
...
urlpatterns = [
    ...
    path('booking/approve/<str:token>/', approve_booking, name='approve_booking'),
    path('booking/reject/<str:token>/', reject_booking, name='reject_booking'),
