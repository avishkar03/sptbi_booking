...
# Make sure to use timezone-aware datetimes
USE_TZ = True

# Configure datetime format for admin and templates
DATETIME_FORMAT = 'j F Y, g:i A'  # Example: 11 May 2023, 2:38 PM
DATE_FORMAT = 'j F Y'  # Example: 11 May 2023
TIME_FORMAT = 'g:i A'  # Example: 2:38 PM
